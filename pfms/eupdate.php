...
if(isset($_POST['submit'])){
	...
	$pPerkg = mysqli_real_escape_string($db->link, $_POST['Price_Per_Dozen']);
...
<table class = "tblone">
	...
	<tr>
		<td>Price Per KG</td>
		<td><input type="text" name="Price_Per_Dozen" value="<?php echo $getData['Price_Per_Dozen']?>"/></td>
	</tr>
	<tr>
